...
/* Draws a white outlined square on a black */
/* background                         */
...
void init()
{
	...
	//if(img.loadImageFromFile("pngImage.png"))
	if(img.loadImageFromFile("Wiggle_01.png"))
	{
					...
					int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow("OpenGL Win32 Example",500,500))
	{
